...
- [x] Redesign the administrator dashboard with a minimal futuristic visual system, including readable theme-matched chart tooltips, while preserving existing behavior and routes.
